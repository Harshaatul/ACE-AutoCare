      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-gray-200 rounded-2xl p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Hyundai Creta • Completed
                </p>
              </div>

              <div className="bg-green-100 text-green-700 px-5 py-2 rounded-xl font-semibold w-fit">
                Completed
              </div>
